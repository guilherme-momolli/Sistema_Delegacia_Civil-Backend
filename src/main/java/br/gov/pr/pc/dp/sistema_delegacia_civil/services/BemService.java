...
import br.gov.pr.pc.dp.sistema_delegacia_civil.repositorys.BemRepository;
...
public class BemService {
    ...
    private final String subFolder = "Imagens/Bem";
    ...
    public Bem atualizar(Bem bemAtualizado, MultipartFile novaImagem) {
        ...
        if (novaImagem != null && !novaImagem.isEmpty()) {
            String novaImagemUrl = fileStorageService.storeFile(novaImagem, subFolder);
